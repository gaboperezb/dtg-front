...
import { IThread, ITimeline, ITake } from '../shared/interfaces';
...
export class TakeTimelineItemComponent {
    ...
    goToDetail() {
        ...
        this.navCtrl.navigateForward([this.router.url.substr(0, 10) + '/take-timeline-detail', this.timeline._id]);
