...
import { IThread, IAnswer, ITimeline } from '../../app/shared/interfaces';
    ...
    sendComment(comment: string, parent: IAnswer, answer: IAnswer) {
        ...
        this.loadingCtrl.create({
            ...
            if (this.authService.isLoggedIn()) {
                ...
                this.threadDiscussionService.postAnswer(data, data.threadId, this.timeline._id, answer.discussion, answer._id)
                                    .subscribe((_answer: any) => {
                                        ...
                                        //socket io
                                        this.webSocketService.emitPost(this.thread._id, "thread", answer.user._id, this.authService.currentUser._id)
