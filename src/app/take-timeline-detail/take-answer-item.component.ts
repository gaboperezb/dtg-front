...
import { IThread, IAnswer, ITimeline, ITake } from '../shared/interfaces';
    ...
    sendComment(comment: string, parent: IAnswer, answer: IAnswer) {
        ...
        this.loadingCtrl.create({
            ...
            if (this.authService.isLoggedIn()) {
                ...
                this.takeDiscussionService.postAnswer(data, data.takeId, this.timeline._id, answer.discussion, answer._id)
                                    .subscribe((_answer: any) => {
                                        ...
                                        //socket io
                                        this.webSocketService.emitPost(this.take._id, "take", answer.user._id, this.authService.currentUser._id)
